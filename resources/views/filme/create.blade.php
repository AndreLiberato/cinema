            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="post" action="{{ route('filme.store') }}" class="mt-6 space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <x-text-input id="diretor" name="diretor" type="text" class="mt-1 block w-full"
                                    required />
                            ...
                            <div>
                                ...
                                <x-text-input id="genero" name="genero" type="text" class="mt-1 block w-full"
                                    required />
                            ...
                            <div>
                                ...
                                <x-text-input id="classificacao_indicativa" name="classificacao_indicativa"
                            ...
                            <div>
                                ...
                                <x-text-input id="duracao" name="duracao" type="time" class="mt-1 block w-full"
                                    required />
                            ...
                            <div>
                                ...
                                <textarea class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" name="sinopse" id="sinopse-textarea" cols="63" rows="5"></textarea>
                                <x-input-error class="mt-2" :messages="$errors->get('capacidade')" />
                            </div>

                            <div>
                                <x-input-label for="copyrights" :value="__('Copyrights')" />
                                <x-text-input id="copyrights" name="copyrights" type="text" class="mt-1 block w-full"
                                    required />
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                @if (session('status') === 'sucesso')
                                    <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)"
                                        class="text-sm text-gray-600 dark:text-gray-400">{{ __('Filme salvo') }}</p>
                                @endif
                            </div>
                        </form>
                    </section>
