<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="birth" :value="__('Data de Nascimento')" />
            <x-text-input id="birth" name="birth" type="date" class="mt-1 block w-full" :value="old('birth', $user->birth)" required autofocus autocomplete="birth" />
